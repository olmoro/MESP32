...
* tXXX - ключ параметра
  ...
  29.07.2022 удалены все ключи. 
  Новые имена разделов будут совпадать с именами режимов прибора.
  В каждом режиме будет возможность удалить все ключи раздела,
  перейдя к параметрам по умолчанию (заводским).
*/
